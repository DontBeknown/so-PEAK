...
public struct HeightMapGenerator : IJobParallelFor
{
    ...
    public HeightMapGenerator(TerrainMeshVariables mv, TerrainHeightmapVariables hv, NativeArray<Color> grad)
    {
        ...
        // Create deterministic offset using seed
        Unity.Mathematics.Random rand = new Unity.Mathematics.Random((uint)(_heightmapVariables.seed == 0 ? 1 : _heightmapVariables.seed));
        _offset = new float2(rand.NextFloat(-10000f, 10000f), rand.NextFloat(-10000f, 10000f));
    }
...
public class TerrainMeshGeneratorEditor : UnityEditor.Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            generator.heightmapVariables.seed = UnityEngine.Random.Range(0, 10000);
