...
namespace Game.Player.Inventory.Commands
{
    ...
    public class PickupItemCommand : IInventoryCommand
    {
        ...
        public PickupItemCommand(IInventoryService inventoryService, ResourceCollector resourceCollector)
        {
        ...
        public bool Execute()
        {
            if (_inventoryService == null || _resourceCollector == null)
            {
            ...
            bool success = _resourceCollector.CollectResource(_inventoryService);
